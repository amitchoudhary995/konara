          ...
          <div className={`flex items-center justify-between transition-all duration-500 ${isScrolled ? 'h-14' : 'h-20'
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `font-nav text-[13px] font-semibold tracking-wider uppercase transition-all duration-300 relative py-2 focus-visible:outline-2 focus-visible:outline-secondary group ${isActive
                          ? 'text-secondary'
                          : (isScrolled ? 'text-text hover:text-secondary' : 'text-white/80 hover:text-white')
                        }`
                      }
            ...
            <div className="hidden lg:flex items-center gap-5">
              <div className="flex items-center gap-2.5">
                <div className={`w-8 h-8 rounded-full border flex items-center justify-center transition-colors duration-300 ${isScrolled ? 'border-secondary/30 text-secondary' : 'border-white/20 text-white'
                  }`}>
                  <Phone size={13} aria-hidden="true" />
                </div>
                <div className="hidden xl:block">
                  <p className={`text-[8px] font-bold uppercase tracking-widest ${isScrolled ? 'text-muted' : 'text-white/60'
                    }`}>
                    Call Us Anytime
                  </p>
                  <a
                    href="tel:+911234567890"
                    className={`font-nav text-xs font-bold transition-colors focus-visible:outline-2 focus-visible:outline-secondary rounded-sm ${isScrolled ? 'text-text hover:text-secondary' : 'text-white hover:text-secondary'
                      }`}
                  >
                    +91 123 456 7890
                  </a>
            ...
            <div className="flex items-center gap-3 lg:hidden">
              <button
                ref={menuButtonRef}
                className={`p-2 focus-visible:outline-2 focus-visible:outline-secondary rounded transition-colors duration-300 ${isScrolled ? 'text-text' : 'text-white'
                  }`}
                onClick={toggleMenu}
